...
// Bootstrap - The most popular framework that template uses as the foundation. Learn more: http://getbootstrap.com
require('bootstrap');
...
window.FormValidation = require("../wladi-workspace/plugins/formvalidation/dist/amd/index.js");
window.FormValidation.plugins.Bootstrap = require("../wladi-workspace/plugins/formvalidation/dist/amd/plugins/Bootstrap.js").default;
...
require('../wladi-workspace/js/vendors/plugins/tempusdominus-bootstrap-4.init.js');
...
require('../wladi-workspace/js/vendors/plugins/bootstrap-datepicker.init.js');
...
// require('../wladi-workspace/js/vendors/plugins/bootstrap-timepicker.init.js');
...
require('../wladi-workspace/plugins/bootstrap-multiselectsplitter/bootstrap-multiselectsplitter.min.js');
...
require('../wladi-workspace/js/vendors/plugins/bootstrap-switch.init.js');
...
require('../wladi-workspace/js/vendors/plugins/dropzone.init.js');
...
require('../wladi-workspace/js/vendors/plugins/bootstrap-markdown.init.js');
...
require('../wladi-workspace/js/vendors/plugins/bootstrap-notify.init.js');
...
window.sessionTimeout = require('../wladi-workspace/plugins/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js');

// JQuery Idletimer - provides you a way to monitor user activity with a page: https://github.com/thorst/jquery-idletimer
require('../wladi-workspace/plugins/jquery-idletimer/idle-timer.min.js');
...
require('../wladi-workspace/js/vendors/plugins/sweetalert2.init.js');

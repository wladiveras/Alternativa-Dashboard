                        ...
                        <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
                            ...
                            <div class="row">
                                <div class="offset-xxl-2 col-xxl-8">
                                    <form class="form" id="kt_form" enctype="multipart/form-data" method="POST" action="{{ route('dash:addorder') }}">
                                        <!--begin: Wizard Step 1-->
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            <h4 class="mb-10 font-weight-bold text-dark">Informações do Pedido</h4>
                                            @csrf
                                            <input type="hidden" name="card-frontid" value="{{ $front }}" />
                                            <input type="hidden" name="card-backid" value="{{ $back }}" />

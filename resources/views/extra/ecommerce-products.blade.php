		...
		<div class="page-wrapper">
			<div class="page-content">
							...
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-lg-3 col-xl-2">
										<a href="{{ url('ecommerce-add-new-products') }}" class="btn btn-light mb-3 mb-lg-0"><i class='bx bxs-plus-square'></i>New Product</a>
									</div>
				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid">
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/01.js') }}"" class="card-img-top" alt="...">
							<div class="">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/02.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/03.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/04.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/05.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/06.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/07.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/08.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/09.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="{{ asset('assets/images/products/10.js') }}"" class="card-img-top" alt="...">
							<div class="">
								<div class="position-absolute top-0 end-0 m-3 product-discount"><span class="">-10%</span></div>
							</div>
							<div class="card-body">

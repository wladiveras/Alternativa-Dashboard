    ...
    <div class="image-input order-avatar image-input-empty image-input-outline" id="avatar-card" style="background-image: url({{ asset('assets/media/users/blank.png') }})">
        ...
        <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Mudar imagem">
            <i class="fa fa-pen icon-sm text-muted"></i>
            <input type="file" name="avatar" accept=".png, .jpg, .jpeg" required />
            <input type="hidden" name="profile_avatar_remove" />
            <div class="invalid-feedback" style="position:absolute;width:100px;left:-100px;top:-8px;font-weight:bold">
                Envie uma FOTO
            </div>
        </label>
        
        <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="cancel" data-toggle="tooltip" title="Cancelar Imagem">
            <i class="ki ki-bold-close icon-xs text-muted"></i>
        </span>
        <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="remove" data-toggle="tooltip" title="Remover Imagem">
            <i class="ki ki-bold-close icon-xs text-muted"></i>
        </span>
    </div>
    ...
    <div class="form-group">
        <label>N Rol Membros<span class="text-danger">*</span></label>
    ...
    <div class="form-group">
        <label>Membro desde<span class="text-danger">*</span></label>
        <input type="text" name="front-input-7" class="form-control" maxlength="50" required>
        <div class="invalid-feedback">O campo é necessário.</div>
    </div>
    
    <div class="form-group">
        <label>Data de Nascimento<span class="text-danger">*</span></label>
        <input type="text" name="front-input-8" class="form-control" maxlength="50" required>
        <div class="invalid-feedback">O campo é necessário.</div>
    </div>

    <div class="form-group">
        <label>Data de Batismo<span class="text-danger">*</span></label>
        <input type="text" name="front-input-9" class="form-control" maxlength="50" required>
        <div class="invalid-feedback">O campo é necessário.</div>
    </div>

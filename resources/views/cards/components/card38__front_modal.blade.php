...
<div class="form-group">
    ...
    <div class="invalid-feedback">O campo <b>Naturalidade</b> é necessário.</div>
</div>
...
<div class="form-group">
    <label>Batizado em <span class="text-danger">*</span></label>
    <input type="text" name="front-input-9" class="form-control" maxlength="50" required>
    <div class="invalid-feedback">O campo <b>Batizado em</b> é necessário.</div>
</div>

<div class="form-group">
    <label>Membro desde <span class="text-danger">*</span></label>
    <input type="text" name="front-input-10" class="form-control" maxlength="50" required>
    <div class="invalid-feedback">O campo <b>Membro desde</b> é necessário.</div>
</div>
...
<div class="form-group">
   <label>Sub Secretaria <span class="text-danger">*</span></label>
   <input type="text" name="front-input-1" class="form-control" maxlength="50" required>
   <div class="invalid-feedback">O campo <b>Sub Secretaria</b> é necessário.</div>
</div>
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="invalid-feedback">O campo <b>Matrícula</b> é necessário.</div>
 </div>